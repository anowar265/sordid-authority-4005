    ...
    <Box p="4" bg="green.100" >
      ...
      <Flex w="80%" marginLeft="200px" justifyContent="space-around" >
        <Box w="40%" maxH="800px">
          ...
          >
            <Box borderBottom="2px dashed" bg="#fff" borderColor="#e0e1e3">
               ...
               />
                    ...
                    <Box> <span className="chooseName">Dedicated relationship manager</span></Box>
                </Flex>
          ...
          <br />
          {/* //className="App-logo" */}
          <Box marginLeft="-220px" marginTop="25%" marginBottom={"-4"}>
            {" "}
            <header>
              <Image w="59%" h="300px" src={logo} alt="logo" />
            </header>
          </Box>
        </Box>
        <Spacer />
        <Box width="25%" borderColor="#e0e1e3">
          ...
          >
            <Box borderBottom="2px dashed" bg="#fff" borderColor="#e0e1e3">
            <Flex>
                    <Box className="cardHeading"><Image
                className="choose"
              ...
              /></Box>
                    <Box><span className="chooseName">Simple setup</span></Box>
                </Flex>
          ...
          >
            ...
            <Flex>
              ...
              />
                    ...
                    <Box><span className="chooseName">Easy fund withdrawal</span></Box>
                </Flex>
        ...
        <Box width="25%" borderColor="#e0e1e3">
          ...
          >
            ...
            <Flex>
              ...
              /></Box>
                    <Box><span marginTop="6" className="chooseName">Safety and security</span></Box>
                </Flex>
          ...
          >
            ...
            <Flex>
              ...
              /></Box>
                    <Box><span className="chooseName">All-in-one mobile app</span></Box>
                </Flex>
